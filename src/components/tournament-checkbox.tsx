...
const TournamentCheckbox = ({ labelText, labelLink, url, theme, isChecked, setIsChecked, hasMissingFields }:{ labelText : string, labelLink?: string, url?: string, theme: ThemeType, isChecked: boolean, setIsChecked: (arg0: boolean) => void, hasMissingFields: boolean }) => {
    ...
    return(
        <div style={{margin: '0 auto', padding: '3px 10px', display: 'flex', alignItems: 'flex-end'}}>
            <input type="checkbox" style={TournamentCheckboxStyle} name="legal" checked={isChecked} onClick={() => { setIsChecked(!isChecked) } } />
